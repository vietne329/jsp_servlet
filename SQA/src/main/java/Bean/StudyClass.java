...
public class StudyClass {
    ...
    public StudyClass(int id,String tenlop, String tenmonhoc, int sotin, int sokip, int sokiplythuyet, int sokipthuchanh) {
        this.id = id;
        this.tenlop = tenlop;
    ...
    public StudyClass(String tenlop, String tenmonhoc, int sotin, int sokip, int sokiplythuyet, int sokipthuchanh) {
        this.tenlop = tenlop;
        this.tenmonhoc = tenmonhoc;
        this.sotin = sotin;
        this.sokip = sokip;
